...
def get_description(filename, path):
    ...
    prompt_genre =  f"""
        Выбери один или несколько жанров из этого списка {genres_list} 
        к которым можно отнести эту книгу. В ответе укажи только один или 
        несколько жанров через запятную, в точности так же как в этом списке {genres_list}. 
        Не пиши в ответе ничего кроме жанра или жанров перечисленных через запятую из 
        списка {genres_list}. Даже если сомневаешься укажи какой-нибудь жанр.
    """
